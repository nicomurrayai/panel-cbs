...
const fieldBase =
  ...
  "placeholder:text-muted/60 transition focus:border-orange focus:outline-none " +
  "focus:ring-2 focus:ring-orange/30 disabled:opacity-60 aria-[invalid=true]:border-danger " +
